...
if ($(".team").length) {    
    $(window).on("scroll", function() {
        ...
        if ($(".team__links").offset().top + $(".team__links").outerHeight() + 10 < $(window).scrollTop() + headerHeight) {
            ...
            let nav = $("<div>", {id: "teamPageMobileNav", style: `background: white; border-bottom: 1px solid #D9D9D9; z-index: 9; display: flex; padding: 10px; gap: 10px; position: fixed; left: 0; right: 0; top: ${headerHeight}px`}),
